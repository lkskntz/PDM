...
import gym_pybullet_drones.envs.obstacles as o

class ObstacleCtrlEnv(CtrlAviary):
    ...
    def reset(self, **kwargs):
        """
        CtrlAviary performs the full reset here.
        Obstacles MUST be injected after super().reset().
        """
